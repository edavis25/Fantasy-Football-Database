...
public class ScrapeStatus extends Task
{
    ...
    private final String[] teamNames = FantasyLibrary.getArrayOfTeams(); //<-- Custom Library
    private final UpdatePlayerStatusFXMLController controller;
    
    /**
     * Default constructor.
     * @param fileURL file path for .csv file
     * @param dbURL String filepath for: fantasy-football-database.db
     * @param control FXML controller class - for interacting with GUI
     * @throws Exception file not found exception
     */
   
    //public ScrapeStatus(String fileURL, CountDownLatch latch) throws Exception
     ...
     */
    public void scrapeDataAndUpdate()
    {
        // Set label text
        javafx.application.Platform.runLater( () ->
        ...
        //for (int i = 0; i <2; i++)
        {
            // Set label2 text to team name currently being scraped
